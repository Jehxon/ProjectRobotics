...
% clear all; close all; MagnetLocWithTemporalBuffer; PlotResults;
% -----
% Project history:
...
%    - Added temporal buffer architecture (using the work of Iker GONZALEZ and 
% Richard ARNAUD, Robotics project)
...
for i = 2 : nbLoops
    ...
    [magnetLost, magnetFound] = detectMagnetLostAndFound(measures, lastMeasures);
...
% It extracts the measures when we lose a magnet
    ...
    if(magnetLost == 1)
         ...
         measure = exactMeasure(a,measures);
        ...
        Y = [ sensorPosAlongXm ;
              sensorRes*( measure - sensorOffset ) ] ;
